  ...
  return (
    <div className="relative min-h-screen select-none overflow-x-hidden">
      ...
      <div className="flex">
        ...
        {/* Content Wrapper */}
        <div 
          className={`flex-1 flex flex-col min-h-screen transition-all duration-300 ease-in-out ${sidebarExpanded ? 'md:pl-[255px]' : 'md:pl-[76px]'} pl-0 print:p-0 print:m-0 print:pl-0`}
        >
          {/* Header Frosted Navbar */}
          <Navbar />

          {/* Main Workspace Frame with Smooth Motion Animations */}
          <main className="flex-1 pt-24 px-4 sm:px-6 md:px-8 w-full max-w-7xl mx-auto min-w-0 print:p-0 print:m-0 print:pt-0 print:max-w-none">
