...
export default function Navbar() {
  ...
  return (
    <header className={`fixed top-0 right-0 left-0 z-20 h-14 glass-navbar flex items-center justify-between px-4 print:hidden ${sidebarExpanded ? 'md:pl-[255px]' : 'md:pl-[85px]'} transition-all duration-200 ease-in-out`}>
      {/* Search Input bar */}
      <div className="flex items-center gap-2 flex-1 max-w-md">
        ...
        <div 
          ...
          className="w-full flex items-center justify-between gap-2 px-3 py-1.5 bg-zinc-100/70 dark:bg-zinc-900/70 border border-zinc-200 dark:border-zinc-800 rounded-lg text-zinc-500 text-xs cursor-pointer hover:border-zinc-300 dark:hover:border-zinc-700 transition-colors select-none"
        >
          <div className="flex items-center gap-2">
            <Search className="w-3.5 h-3.5 text-zinc-400" />
            <span>Search workspace...</span>
          </div>
          <kbd className="hidden sm:inline-block px-1.5 py-0.5 text-[10px] bg-zinc-200 dark:bg-zinc-800 text-zinc-500 rounded font-mono">
            ⌘K
          </kbd>
        </div>
        ...
        <button
          ...
          className="w-8 h-8 flex items-center justify-center rounded-lg bg-zinc-100 dark:bg-zinc-900 hover:bg-indigo-600/10 text-zinc-500 hover:text-indigo-600 border border-zinc-200 dark:border-zinc-800 transition-colors cursor-pointer"
        ...
        {user?.role !== 'ROLE_EMPLOYEE' && (
          <div className="relative">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-medium text-xs shadow-xs transition-colors cursor-pointer"
            >
